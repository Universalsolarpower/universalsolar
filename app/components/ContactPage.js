...
export default function ContactPage() {
  ...
  <div className="col-12">
    <div className="glass-card fade-in">
      <h3 className="mb-4 text-center" style={{ color: 'var(--primary-blue)' }}>
        Find Us
      </h3>
      <div
        style={{
        ...
        <div className="row mt-5">
          ...
          <div className="col-lg-6">
            <div className="glass-card fade-in">
              ...
              <p> Savings depend on your location, energy usage, and system size. Most customers save 50-90% on their electricity bills, with typical payback periods of 6-10 years. </p>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="glass-card fade-in">
              <h5 style={{ color: 'var(--eco-green)' }}>What financing options are available?</h5>
              <p> We offer various financing solutions including solar loans, leases, and power purchase agreements (PPAs). We also help with federal and state incentive applications. </p>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="glass-card fade-in">
              <h5 style={{ color: 'var(--eco-green)' }}>How long does installation take?</h5>
              <p> Most residential installations are completed in 1-3 days, while commercial projects may take 1-4 weeks depending on size and complexity. </p>
            </div>
          </div>
          <div className="col-lg-6">
            <div className="glass-card fade-in">
              <h5 style={{ color: 'var(--eco-green)' }}>What warranty do you provide?</h5>
              <p> We offer 25-year warranties on solar panels and 10-year warranties on inverters, and 10-year warranties on our installation workmanship. </p>
            </div>
          </div>
        </div>
      </div>
